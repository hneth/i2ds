...
The latest courses **Introduction to Data Science (using R, ADILT)** take place at the [University of Konstanz](https://www.uni-konstanz.de/en/) in\ 2026. 
...
* Online platforms (at [uni.kn](https://www.uni-konstanz.de/en/)):
    - Course registration system [ZEuS](`r url_zeus`): 
    [i2ds 1](`r url_i2ds_zeus`) | [i2ds 2](`r url_i2ds_2_zeus`)
    - Course management system [Ilias](`r url_ilias`): 
    [i2ds 1](`r url_i2ds_ilias`) | [i2ds 2](`r url_i2ds_2_ilias`)
